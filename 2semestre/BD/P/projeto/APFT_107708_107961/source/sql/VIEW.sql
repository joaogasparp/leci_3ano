...
SELECT b.Num_Bomba, b.Marca, b.Preco, p.Codigo AS 'Codigo Produto', p.TaxaIva, p.Quantidade AS 'Quantidade Produto', p.Preco AS 'Preco Produto'
...
SELECT e.Num_Encomenda, e.Data_entrega, f.NIF AS 'NIF Fornecedor', f.Marca, g.NIF AS 'NIF Gerente', g.Gabinete
FROM GAS_Encomenda e
JOIN GAS_Fornecedor f ON e.F_NIF = f.NIF
JOIN GAS_Gerente g ON e.G_NIF = g.NIF;
GO
