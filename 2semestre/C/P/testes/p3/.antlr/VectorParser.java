// Generated from /home/joao/Desktop/leci_3ano/2semestre/C/P/testes/p3/Vector.g4 by ANTLR 4.13.1
...
public class VectorParser extends Parser {
	...
	public static final int
		...
		VECTOR=10, NUMBER=11, INT=12, FLOAT=13, ID=14, WS=15, COMMENT=16, ERROR=17;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"NUMBER", "INT", "FLOAT", "ID", "WS", "COMMENT", "ERROR"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 19764L) != 0)) {
				{
				{
				setState(6);
				stat();
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 2:
						...
						match(T__6);
						setState(41);
						((ExprInternalProductContext)_localctx).e2 = expr(7);
						}
						break;
					case 3:
						{
