...
public class LangComplexParser extends Parser {
	...
	public static final int
		RULE_program = 0, RULE_stat = 1, RULE_expr = 2, RULE_complex = 3, RULE_float = 4;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "stat", "expr", "complex", "float"
		};
	}
	...
	public static class StatAssigmentContext extends StatContext {
		public TerminalNode VARIABLE() { return getToken(LangComplexParser.VARIABLE, 0); }
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ExprIContext extends ExprContext {
		public ExprIContext(ExprContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 6:
				{
				_localctx = new ExprIContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(37);
				match(T__9);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(43);
						((ExprSumSubContext)_localctx).e2 = expr(10);
						}
						break;
					case 2:
						{
						...
						setState(46);
						((ExprMulDivContext)_localctx).e2 = expr(8);
						}
						break;
					}
					} 
	...
	public static class ComplexContext extends ParserRuleContext {
		public List<TerminalNode> NUM() { return getTokens(LangComplexParser.NUM); }
		public TerminalNode NUM(int i) {
			return getToken(LangComplexParser.NUM, i);
		}
